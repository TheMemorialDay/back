...
import com.korit.thememorialday.repository.TelAuthNumberRepository;
...
public class AuthServiceImplement implements AuthService {
	...
	public ResponseEntity<ResponseDto> telAuthCheck(TelAuthCheckRequestDto dto) {
		...
		try {
			boolean isMatched = telAuthNumberRepository.existsByTelNumberAndTelAuthNumber(telNumber, telAuthNumber);
